...
def animate_box(correct_answers, total_questions):
    ...
    box_height = 2  # Height of the box
    ...
    # Draw the box
    ax.add_patch(patches.Rectangle((0, 0), box_width, box_height, linewidth=2, edgecolor='black', facecolor='lightgray'))

    # Draw the filled part of the box
    ax.add_patch(patches.Rectangle((0, 0), box_width, fill_height, linewidth=0, edgecolor='black', facecolor='green'))
    ...
    # Display the plot
    st.pyplot(fig)
    st.write(f"The box is {int((correct_answers / total_questions) * 100)}% full of love!")
...
def final_message(correct_answers, total_questions):
    st.write(f"The box is full of love!")
