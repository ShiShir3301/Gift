...
def main():
    ...
    answer_revealed, st.session_state.correct_answers = ask_question(current_question['question'], current_question['choices'], current_question['correct_answer'], st.session_state.question_index, st.session_state.correct_answers)
